...
def test_elastic(parser):
    archive = EntryArchive()
    parser.parse('tests/data/elastic-constants.json', archive, None)
...
def test_phonon(parser):
    archive = EntryArchive()
    parser.parse('tests/data/openkim_archive_phonon-dispersion-relation-cubic-crystal-npt.json', archive, None)
...
def test_stacking_fault(parser):
    archive = EntryArchive()
    parser.parse('tests/data/StackingFaultFccCrystal_0bar_Ac__TE_567672586460_002.json', archive, None)
